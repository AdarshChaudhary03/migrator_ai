...
def clone_repository(
    ...
    base_path: Optional[str] = None
        ...
        try:
            ...
            validation_success, validation_error = self._validate_repository(local_path, branch)
    ...
    def handle_zip_upload(self, zip_file_path: str, extract_path: Optional[str] = None) -> Tuple[bool, str, str]:
        """
        ...
        try:
            ...
            if not extract_path:
                ...
                extract_path = os.path.join(self.base_path, zip_name)
            ...
            git_init_success, git_error = self._initialize_git_repository(extract_path)
    ...
    def get_commit_hash(self, repo_path: str) -> Tuple[bool, str, str]:
        """
    ...
    def get_current_branch(self, repo_path: str) -> Tuple[bool, str, str]:
        """
    ...
    def _validate_repository(self, repo_path: str, expected_branch: str) -> Tuple[bool, str]:
        """
        ...
        try:
            ...
            success, current_branch, error = self.get_current_branch(repo_path)
            if not success:
    ...
    def _initialize_git_repository(self, repo_path: str) -> Tuple[bool, str]:
        """
...
def create_git_tool(base_path: str = None) -> GitTool:
    """Factory function to create a GitTool instance."""
    return GitTool(base_path)
